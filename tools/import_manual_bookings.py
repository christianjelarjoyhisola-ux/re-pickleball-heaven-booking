...
DEFAULT_WORKBOOK = Path(r"C:\Users\casto\Downloads\01.-re-pickleball-heaven-2026-Pickleball-Booking.xlsx")
...
def parse_config():
    """Load R&E Supabase REST credentials for manual booking imports."""
    values = {}
    if ENV_FILE.exists():
    ...
    if not url or not key:
        raise RuntimeError("SUPABASE_URL and SUPABASE_ANON_KEY are required in .env.local or environment variables.")
