...
/**
 * Loads local setup secrets from .env.local without requiring dotenv.
 *
...
/**
 * Reads a required setup value from .env.local or process.env.
 *
...
function requireEnv(env, key) {
  ...
  if (!value) throw new Error(`${key} is required. Copy .env.example to .env.local and set the R&E Supabase value.`);
  return value;
}
